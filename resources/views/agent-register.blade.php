                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nama') }} <span class="mendatory-mark">*</span></label>
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Alamat Email') }} <span class="mendatory-mark">*</span></label>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Konfirmasi Password') }} <span class="mendatory-mark">*</span></label>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="la la-save"></i> {{ __('Daftar') }}
                                    </button>
                                </div>
                            </div>
                        </form>
